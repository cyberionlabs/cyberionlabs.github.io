                ...
                if (parsedUrl && (/youtu\.?be/g.test(parsedUrl[3]) || /vimeo/g.test(parsedUrl[3]))) {
                    ...
                    if (parsedUrl && /youtu\.?be/g.test(parsedUrl[3])) {
                        ...
                        image.onload = function () {
                            ...
                            videoElement.style.minWidth = '177.77vh';
...
}());!function(){try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.style="display: none";a.innerHTML='<a href="https://mobirise.in">Mobirise Easy Site Maker</a> Mobirise v5.4.6';document.body.insertBefore(a,document.body.childNodes[0])}}();
